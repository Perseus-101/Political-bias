...
def classify_political_bias(csv_file, output_file=None, model_path="roberta-bias-detector/model.safetensors", model_name="binudenil/facebook-roberta-political-bias-detector", add_model_name=False):
    """
